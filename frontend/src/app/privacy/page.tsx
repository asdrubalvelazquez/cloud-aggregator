      ...
      <div className="max-w-4xl mx-auto bg-white shadow-sm rounded-lg p-8">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-4">
            Cloud Aggregator ("we", "our", or "us"), accessible at cloudaggregatorapp.com, is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your information when you use our service to manage and interact with your Google Drive accounts.
          </p>
        </section>
