...
import { getOnedriveRowActions } from "@/lib/onedriveRowActions";

type OnedriveRowActionsMenuProps = {
  fileId: string;
  fileName: string;
  webViewLink?: string;
  isFolder: boolean;
...
export default function OnedriveRowActionsMenu({
  fileId,
  fileName,
  webViewLink,
  isFolder,
  ...
  const actions = getOnedriveRowActions({
    fileId,
    fileName,
    webViewLink,
    isFolder,
